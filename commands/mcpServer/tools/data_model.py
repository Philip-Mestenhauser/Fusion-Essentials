...
def list_project_files_handler(project: str = "", project_id: str = "") -> dict:
    ...
    try:
        ...
        _walk_folder(root, files, truncated, depth=0, folder_path="")
    except Exception as e:
...
_list_project_files_tool = (
    Tool.create_simple(
        ...
        description=(
            ...
            "interface. Folders are traversed recursively. Read-only. Results are "
            "capped for very large projects (see 'truncated')."
        ),
    )
