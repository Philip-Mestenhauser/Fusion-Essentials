...
| `_design_common` | DESIGN MODE: get_mode_handler - design_get's 'mode' slice, a can{} map agreeing with ModeGuards; health_handler - its timeline error/warning rollup; run_in_base_feature/base_feature_run_wrapper - a mutation needing a base-feature scope, always finished; timeline_census/timeline_item_key/census_caveat - the token-keyed census a delete or suppress diffs; no_timeline_reason - the no-timeline refusal |
