...
TOOL_DESCRIPTION = (
    ...
    "edit target so subsequent sketch_create / extrude build into it. WRITES."
)
...
tool = (
    ...
    .add_input_property("rotate_axis", {"type": "string", "description": "World axis for the orientation rotation: x | y | z (default z)."})
    .strict_schema()
)
