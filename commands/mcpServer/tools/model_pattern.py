...
"""MCP building blocks: rectangular & circular PATTERNS of component occurrences or bodies.
  ...
  model_pattern_rectangular -> duplicate occurrences/bodies in a grid, along one axis or two. WRITES.
  model_pattern_circular    -> duplicate them evenly around an axis over a total angle. WRITES.
"""
