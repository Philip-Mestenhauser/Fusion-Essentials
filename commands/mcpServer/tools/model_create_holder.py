...
agent-drivable form of the "Add Tool Holder" command).
  ...
  model_create_holder -> reduce a body of revolution (the holder geometry) to a stack of
...
tool = (
    Tool.create_simple(name="model_create_holder", description=TOOL_DESCRIPTION)
