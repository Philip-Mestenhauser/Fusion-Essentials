...
_EXEMPT = {
    ...
    'design_delete_feature': 'inline: timeline health is diffed around deleteMe() and authors the downstream warning',
    'design_delete_occurrence': 'inline: timeline health is diffed around deleteMe() and authors the downstream warning',
    ...
    'sketch_project': 'inline: addressable entity counts are diffed around project2(); no new entities is an error',
    'sketch_set_text': 'inline: sketchTexts count is diffed around add() on create; expression before/after read on edit',
