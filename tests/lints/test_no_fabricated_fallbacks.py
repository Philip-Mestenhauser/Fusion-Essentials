...
_ALLOWED = {
    "_assembly_detail.py:412": "a joint origin's offsetX genuinely defaults to 0 (live-verified: a "
                               "face/sketch-anchored JO reports geometry.origin as-is)",
    "_assembly_detail.py:413": "offsetY, same contract as offsetX",
    "_assembly_detail.py:414": "offsetZ, same contract as offsetX",
