...
_EXEMPT = {
    ...
    'assembly_move': 'inline: the transform is re-read; an unchanged pose errors, position_mm is the actual',
    ...
    'cam_edit_setup': 'inline: machine assignment is re-read and gated; params/bodies report their post-set state',
    ...
    'doc_insert_occurrence': 'inline: addByInsert return is gated and the occurrence is checked isValid',
