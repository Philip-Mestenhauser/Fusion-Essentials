...
| · | `sketch_get` | Read sketches by zoom level: a summary list of the design's sketches (paged by max_results; 'truncated' means the note names the narrowing), or ONE sketch's ove... |
