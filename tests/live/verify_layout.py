...
_MEASURED_BOX = {
    "ArrP1": [470.0, 855.8, 1479.0, 1654.0],
    "ArrP2": [550.0, 862.3, 1444.0, 1629.0],
    "ArrP3": [670.0, 876.3, 1479.0, 1628.5],
    "AsbPin": [440.0, 460.0, 1789.0, 1809.0],
    "AsbPlate": [430.0, 470.0, 1779.0, 1819.0],
    "AxisPost": [1695.0, 1705.0, 115.0, 125.0],
    "BallPost": [1695.0, 1705.0, 115.0, 125.0],
    "BallSphere": [1694.0, 1706.0, 114.0, 126.0],
    "BayCameo": [654.0, 744.0, 1344.0, 1404.0],
    "BoreCameo": [302.5, 313.5, 2284.5, 2295.5],
    "Bracket": [-60.0, 60.0, -40.0, 40.0],
    "CombineCameo": [392.0, 442.0, 1344.0, 1394.0],
    "ConA": [440.0, 460.0, 1934.0, 1954.0],
    "ConB": [440.0, 460.0, 1934.0, 1954.0],
    "DatumBench": [200.0, 260.0, 2042.0, 2082.0],
    "DihedralL": [794.0, 854.0, 1934.0, 1974.0],
    "EmbossBlock": [600.0, 640.0, 100.0, 120.0],
    "FeatureCameo": [-240.0, 390.0, -50.0, 110.0],
    "FillDemo": [-6.0, 6.0, -6.0, 6.0],
    "GrpA": [200.0, 220.0, 1779.0, 1799.0],
    "GrpB": [280.0, 300.0, 1779.0, 1799.0],
    "HolderPart": [100.0, 140.0, 2142.0, 2162.0],
    "Hub": [1160.0, 1240.0, -40.0, 40.0],
    "IndBal": [723.0, 757.0, 1794.0, 1804.0],
    "IndCyl": [633.0, 667.0, 1794.0, 1804.0],
    "IndPin": [678.0, 712.0, 1794.0, 1804.0],
    "IndPla": [768.0, 802.0, 1794.0, 1804.0],
    "IndRev": [543.0, 577.0, 1794.0, 1804.0],
    "IndRig": [813.0, 847.0, 1794.0, 1804.0],
    "IndSld": [588.0, 622.0, 1794.0, 1804.0],
    "JawFixed": [-70.0, 70.0, 43.0, 78.0],
    "JawMoving": [-70.0, 70.0, -78.0, -43.0],
    "JointBase": [530.0, 860.0, 1779.0, 1819.0],
    ...
    "MateArm": [715.388531, 749.833395, -1835.749537, -1810.089283],
    "MateSeat": [520.0, 540.0, 1934.0, 1954.0],
    "Msh": [803.8, 879.0, 1343.7, 1419.0],
    "PatchRail": [600.0, 620.0, 2042.0, 2042.0],
    "PinCameo": [-189.0, 430.0, 1719.0, 2467.0],
    "PipeCut": [800.0, 840.0, -20.0, 20.0],
    "PipeHalf": [757.0, 763.0, -3.0, 3.0],
    "PipeRun": [715.0, 725.0, -5.0, 5.0],
    "PoseCameo": [400.0, 420.0, 1934.0, 1954.0],
    "ReplBlock": [660.0, 690.0, 0.0, 30.0],
    "ReplRoof": [655.0, 695.0, -80.0, 80.0],
    "RevolveCameo": [22.0, 38.0, -8.0, 8.0],
    "RigidPost": [1695.0, 1705.0, 115.0, 125.0],
    "RmScratch": [600.0, 620.0, 2142.0, 2162.0],
    "Ruled": [680.0, 720.0, 2027.0, 2042.0],
    "RuledSolid": [1700.0, 1740.0, 1942.0, 1982.0],
    "SAlign": [419.0, 460.0, 2042.0, 2072.0],
    "SDel": [519.6, 620.4, 2041.92, 2062.08],
    "SHole": [600.0, 640.0, -10.0, 10.0],
    "SRev": [-10.0, 10.0, -10.0, 10.0],
    "STOCK": [-63.0, 63.0, -43.0, 43.0],
    "ScaleBlock": [1244.1, 1346.5, 322.0, 403.2],
    "ShellCap": [200.0, 230.0, 2142.0, 2172.0],
    "Spl": [860.0, 900.0, 2042.0, 2082.0],
    "Stc": [960.0, 980.0, 2042.0, 2062.0],
    "Surf": [317.0, 360.0, 2042.0, 2072.0],
    "SwarfFrustum": [674.0, 734.0, 1942.0, 1982.0],
    "SweepCameo": [245.0, 255.0, -5.0, 5.0],
    "TangentLoop": [858.5, 921.5, 2160.5, 2223.5],
    "TangentRun": [1614.0, 1680.0, 2040.5, 2102.0],
    "ThreadBore": [939.0, 963.0, 1344.0, 1368.0],
    "ThreadPost": [450.13275, 479.86725, 2132.13275, 2161.86725],
    "ThreadPost2": [530.075, 539.925, 2142.075, 2151.925],
    "TorusPost": [1695.0, 1705.0, 175.0, 185.0],
    "TorusRing": [1654.0, 1746.0, 134.0, 226.0],
    "TwicePlaced": [380.0, 440.0, 2142.0, 2162.0],
    "TwoSideCap": [290.0, 320.0, 2142.0, 2172.0],
