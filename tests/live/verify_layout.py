...
_MEASURED_BOX = {
    ...
    "AsbPin": [1032.0, 1052.0, 1489.0, 1509.0],
    "AsbPlate": [1022.0, 1062.0, 1479.0, 1519.0],
    ...
    "BoreCameo": [402.5, 413.5, 2156.5, 2167.5],
    "Bracket": [-60.0, 60.0, -40.0, 40.0],
    "CombineCameo": [392.0, 442.0, 1344.0, 1394.0],
    "ConA": [754.0, 774.0, 1779.0, 1799.0],
    "ConB": [754.0, 774.0, 1779.0, 1799.0],
    "DatumBench": [460.0, 520.0, 1934.0, 1974.0],
    "DihedralL": [200.0, 260.0, 1934.0, 1974.0],
    ...
    "HolderPart": [380.0, 420.0, 2034.0, 2054.0],
    "Hub": [1160.0, 1240.0, -40.0, 40.0],
    "IndBal": [393.0, 427.0, 1794.0, 1804.0],
    "IndCyl": [303.0, 337.0, 1794.0, 1804.0],
    "IndPin": [348.0, 382.0, 1794.0, 1804.0],
    "IndPla": [438.0, 472.0, 1794.0, 1804.0],
    "IndRev": [213.0, 247.0, 1794.0, 1804.0],
    "IndRig": [483.0, 517.0, 1794.0, 1804.0],
    "IndSld": [258.0, 292.0, 1794.0, 1804.0],
    "JawFixed": [-70.0, 70.0, 43.0, 78.0],
    "JawMoving": [-70.0, 70.0, -78.0, -43.0],
    "JointBase": [200.0, 530.0, 1779.0, 1819.0],
    "LeadScrew": [-30.0, 30.0, -125.0, -80.0],
    "LnkA": [594.0, 614.0, 1779.0, 1799.0],
    "LnkB": [594.0, 614.0, 1779.0, 1799.0],
    "LoftCameo": [300.0, 332.0, 1344.0, 1376.0],
    "MateArm": [88.328425, 122.773289, -2017.649574, -1991.98932],
    "MateSeat": [834.0, 854.0, 1779.0, 1799.0],
    "Msh": [651.8, 727.0, 1343.7, 1419.0],
    "PatchRail": [860.0, 880.0, 1934.0, 1934.0],
    "PinCameo": [403.0, 1022.0, 1419.0, 2167.0],
    "PipeCut": [800.0, 840.0, -20.0, 20.0],
    "PipeHalf": [757.0, 763.0, -3.0, 3.0],
    "PipeRun": [715.0, 725.0, -5.0, 5.0],
    "PoseCameo": [714.0, 734.0, 1779.0, 1799.0],
    ...
    "RmScratch": [880.0, 900.0, 2034.0, 2054.0],
    "Ruled": [940.0, 980.0, 1919.0, 1934.0],
    "RuledSolid": [1040.0, 1080.0, 1934.0, 1974.0],
    "SAlign": [679.0, 720.0, 1934.0, 1964.0],
    "SDel": [779.6, 880.4, 1933.92, 1954.08],
    "SHole": [600.0, 640.0, -10.0, 10.0],
    "SRev": [-10.0, 10.0, -10.0, 10.0],
    "STOCK": [-63.0, 63.0, -43.0, 43.0],
    "ScaleBlock": [1244.1, 1346.5, 322.0, 403.2],
    "ShellCap": [480.0, 510.0, 2034.0, 2064.0],
    "Spl": [200.0, 240.0, 2034.0, 2074.0],
    "Stc": [300.0, 320.0, 2034.0, 2054.0],
    "Surf": [577.0, 620.0, 1934.0, 1964.0],
    "SwarfFrustum": [988.0, 1048.0, 1787.0, 1827.0],
    "SweepCameo": [245.0, 255.0, -5.0, 5.0],
    "TangentLoop": [198.5, 261.5, 2152.5, 2215.5],
    "TangentRun": [954.0, 1020.0, 2032.5, 2094.0],
    "ThreadBore": [787.0, 811.0, 1344.0, 1368.0],
    "ThreadPost": [730.13275, 759.86725, 2024.13275, 2053.86725],
    "ThreadPost2": [810.075, 819.925, 2034.075, 2043.925],
    "TorusPost": [1695.0, 1705.0, 175.0, 185.0],
    "TorusRing": [1654.0, 1746.0, 134.0, 226.0],
    "TwicePlaced": [660.0, 720.0, 2034.0, 2054.0],
    "TwoSideCap": [570.0, 600.0, 2034.0, 2064.0],
