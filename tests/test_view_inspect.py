...
class TestOrient:
    ...
    def test_front_eye_placed_on_minus_y_at_preserved_distance(self):
    ...
    def test_top_orientation_uses_plus_y_up(self):
    ...
    def test_focus_only_translates_eye_by_target_delta(self):
        ...
        _install([FakeOcc("Part", bbox=FakeBBox((0, 0, 4), (2, 2, 8)))])  # center (1,1,6)
...
class TestSnapshotRestore:
    ...
    def test_restore_reinstates_isolation(self):
        ...
        _install([a], doc_name="IsoRestore")
        iv._SNAPSHOTS.clear()
        _payload(iv.handler(action="snapshot"))
