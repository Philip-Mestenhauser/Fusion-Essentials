...
`tools/list` to confirm. The very first load after adding a brand-new tool still needs one
manual Stop/Run in Fusion's Add-Ins dialog; after that, `reload_addin` handles reloads.
